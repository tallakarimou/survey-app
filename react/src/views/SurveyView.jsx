       ...
       {loading&& <div className="text-center text-lg"> Loading...</div>}
          {!loading && <form action="#" method="post" onSubmit={onSubmit}>
              <div className="shadow sm:overflow-hidden sm:rounded-md">
                  ...
                  <div className="space-y-6 bg-white px-4 py-4 sm-4 p-6">
                      ...
                      <div>
                          ...
                          <div className="mt-1 flex items-center">
                              ...
                              {!survey.image_url && (<span className="flex justify-center items-center
                 text-gray-400 h-12 w-12 overflow-hidden rounded-full bg-gray-100">
                ...
                bg-white py-2 px-3 text-sm font-medium leading-4 text-gray-700
              ...
              text-gray-700">
                ...
                focus:border-indigo-50 focus:ring-indigo-500 sm:text-sm">
                          </textarea>
                          {/* description */}
                    ...
                    focus:ring-indigo-500 "
                          ...
                          <div className="mt-1 flex items-start">
                              <div className="flex h-5 space-y-0">
                                  <input
                                      id="status"
                                      name="status"
                                      type="checkbox"
                                      ...
                                      onChange={(ev) => setSurvey({
                                          ...survey, status: ev.target.checked
                                      })}
