...
class SurveyController extends Controller
{
    ...
    public function update(SurveyUpdateRequest $request, Survey $survey)
    {
        ...
        // get ids as plain array of existing survey questions
        $existingIds = $survey->questions()->pluck('id')->toArray();

        // get ids as plain array of new survey questions
    ...
    {
        // check if image is valid base64 string: we use JSON objet
